    ...
    protected void onHandleIntent(Intent intent) {
        ...
        switch (action) {
            case IntentContract.ACTION_REFRESH_AUTO:
                boolean isEnablingAutoRefresh = intent.getBooleanExtra(
                        IntentContract.EXTRA_REFRESH_AUTO, false);
            ...
            case IntentContract.ACTION_PURGE_DATABASE: {
                ...
                boolean isEnablingPurge = intent.getBooleanExtra(
                        IntentContract.EXTRA_PURGE_DATABASE, false);
                if (isEnablingPurge) {
        ...
        for (ContentValues rawValue : rawValues) {
            ...
            try {
                ...
                cursor = getContentResolver()
                        .query(Entity.CONTENT_URI, null, where, null, null);
